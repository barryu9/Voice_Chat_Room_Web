  ...
  return (
    ...
    >
      ...
      <button
        ...
        disabled={disabled}
        className="absolute bottom-3 right-3 w-10 h-10 flex items-center justify-center rounded-full bg-primary-600 hover:bg-primary-500 disabled:from-gray-700 disabled:to-gray-700 disabled:text-gray-500 text-white transition-all active:scale-95"
        title="加入"
      >

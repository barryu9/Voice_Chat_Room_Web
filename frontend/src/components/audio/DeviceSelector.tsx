    ...
    <div className="flex gap-3">
      <div className="flex items-center gap-2">
        ...
        <select
          ...
          className="bg-gray-800/60 border border-gray-600/50 rounded-lg px-3 py-1.5 text-sm text-white focus:outline-none focus:border-primary-500/50 transition-all"
        >
          {inputs.map((d) => (

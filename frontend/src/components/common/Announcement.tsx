  ...
  return (
    <div className="space-y-2">
      {visible.map((a) => (
        <div
          key={a.id}
          className="theme-alert-info px-4 py-3 rounded-xl flex items-center justify-between animate-in fade-in slide-in-from-top-2"
        >
          <span className="text-sm">
            <span className="theme-alert-meta mr-2">{formatTime(a.createdAt)}</span>
            {a.message}
          </span>
          <button
